...
package RequestGenerator2_topEntity_types is


  subtype rst_System is std_logic;

  type Tup2_1 is record
    Tup2_1_sel0_boolean : boolean;
    Tup2_1_sel1_std_logic_vector : std_logic_vector(33 downto 0);
  end record;
...
package body RequestGenerator2_topEntity_types is
  ...
  begin
    return (toSLV(p.Tup2_1_sel0_boolean) & toSLV(p.Tup2_1_sel1_std_logic_vector));
  end;
  ...
  begin
    return (toSLV(p.Tup2_0_sel0_std_logic_vector) & toSLV(p.Tup2_0_sel1_Tup2_1));
  end;
