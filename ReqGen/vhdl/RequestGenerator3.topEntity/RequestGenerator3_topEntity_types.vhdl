...
package RequestGenerator3_topEntity_types is


  subtype rst_System is std_logic;

  type Tup2_0 is record
    Tup2_0_sel0_boolean : boolean;
    Tup2_0_sel1_std_logic_vector : std_logic_vector(33 downto 0);
  end record;
  ...
  type Tup2 is record
    Tup2_sel0_std_logic_vector : std_logic_vector(10 downto 0);
...
package body RequestGenerator3_topEntity_types is
  ...
  begin
    return (toSLV(p.Tup2_0_sel0_boolean) & toSLV(p.Tup2_0_sel1_std_logic_vector));
  end;
  ...
  begin
    return (toSLV(p.Tup2_sel0_std_logic_vector) & toSLV(p.Tup2_sel1_Tup2_0));
  end;
